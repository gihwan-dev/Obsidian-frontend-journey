...
즉, 브라우저나 Node.js 에서 실행되는 30-Resources/Frontend/JavaScript/JS 는 ES<년도> 표준을 구현한 것이다.
...
- 30-Resources/Frontend/HTML/CSS는 상위 호환성이 있지만 하위 호환성이 없는 반대의 경우
- 프로그래밍 언어에서 상위 호환성을 구현하는 것은 실질적으로 불가능
  - 30-Resources/Frontend/HTML/CSS는 선언적 성격이라 인식할 수 없는 부분을 건너뛸 수 있음
