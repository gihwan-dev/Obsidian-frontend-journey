...
tags:
  - "JavaScript"
description: "모듈을 default import로 가져오면 메서드 재할당이 가능해 위험성이 있다. 구조 분해 문법을 쓰면 상수로 바인딩되기 때문에 이런 문제가 없다는 걸 Node.js 디자인 패턴 바이블을 읽으며 정리했다."
importedAt: "2026-02-18T07:28:49.893Z"
aliases:
  - "JavaScript 모듈을 import 할 때 destructuring(구조 분해 문법)을 사용해야 하는 이유(feat. 지극히 주관적)"
---
