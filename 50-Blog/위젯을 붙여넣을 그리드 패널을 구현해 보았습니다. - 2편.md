...
featured: true
draft: false
published: "2024-05-26T08:01:35.146Z"
tags:
  - development
  - monorepo
  - project
description: HTML5 드래그 이벤트의 제약을 넘어 mouse 이벤트 기반 커스텀 드래그 앤 드롭과 grid-area로 위젯을 실제 패널에 붙여넣는 과정을 정리한 2편입니다.
aliases:
  - 위젯을 붙여넣을 그리드 패널을 구현해 보았습니다. - 2편
---
