...
마지막 단계로, 더 많은 성능 향상을 위해서 Contextual Retrieval을 다른 기술과 통합할 수 있다. 전통적인 RAG에서, AI 시스템은 지식 베이스를 검색해 잠재적으로 관련 있는 정보 조각들을 찾는다. 지식 베이스가 클수록, 이 초기 검색 단계에서 수백 개에 달하는 다양한 중요도와 관련선을 가진 조각들이 반환되는 경우가 많다.
